        ...
        messages=[
            {
                "role": "system",
                "content": (
                    f"당신은 '{place_name}' 장소에 대한 여행 도우미입니다. "
                    "웹 검색 결과를 바탕으로 질문에 친절하고 구체적으로 답변해주세요.\n\n"
                    "반드시 지켜야 할 규칙:\n"
                    "- 순수 텍스트로만 답변하세요.\n"
                    "- URL, 링크, 출처, 사이트명은 절대 포함하지 마세요.\n"
                    "- **, __, [], (), # 등 마크다운 특수문자를 절대 사용하지 마세요.\n"
                    "- 강조가 필요하면 특수문자 없이 따옴표('')를 사용하세요."
                ),
            },
            {"role": "user", "content": prompt},
        ],
